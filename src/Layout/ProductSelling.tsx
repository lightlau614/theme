                ...
                <DialogContent>
                    <DialogContentText className='text-center'>
                        ...
                        <div className='row d-flex justify-content-center color-F91B display-5'>
                            <img className='img-fluid' src={require('../Resources/Asset/images/Size_Chart.png')} />
                        </div>
                    </DialogContentText>
                </DialogContent>
            </Dialog>
        ...
        <>
            ...
            <div className='container'>
                <div className='row mt-5 '>
                    <div className='col col-md-auto col-lg-8'>
                        <div className='row'>
                            <div className='col col-sm-12 col-md-9 col-lg-9 d-flex justify-content-center'>
                                        ...
                                        return (
                                            <>
                                                {/* <div className='col-sm-3'> */}
                                                    <div className='preview-sm-pic col-md-4 col-lg-auto'>
                    ...
                    <div className='col col-md-0 col-lg-4'>
                            ...
                            {Object.values(clothColor).map((item:any, index:any)=> {
                                return (
                                    <>
                                        ...
                                        <div className='col col-sm-1 pt-2 ps-0 pe-0 d-flex justify-content-start'>
                        ...
                        <div className='bg-F91B border-radius-25 w-50'>
