        ...
        <>
            {displayData? displayData.map((item:any) => {
                ...
                return (
                    ...
                    <div className='row d-flex justify-content-center p-0'>
                                        ...
                                        <>
                                            <div className='position-relative border-radius-25' style={{border: '2px solid #7D75FE'}}>
                                                <div className='row d-flex justify-content-end text-end bg-7DFE pt-1 pb-1' style={{borderTopLeftRadius: '20px', borderTopRightRadius: '20px', height: '35px'}}>
                                                    <div className='col-11 col-md-3 text-white text-end'>
                                                        {item.likes}
                                                    </div>
                        ...
                        <div className='text-start font-TT'>
                            <div className='font-TT'>
                                Theme x Silkism
                            </div>
                            <div className='row'>
                                <div className='col-4 mt-3 mb-3 font-TTB display-6'>    
                                    {display_id}
                                </div>
                                <>
                                    <div className='col mb-2 text-end mt-auto mb-auto'>
                                    {item.User_Id !== null?
                                        <>
                            ...
                            <div className='border-radius-25 pt-2 pb-2 mb-2' style={{border: '2px solid #7D75FE'}}>
                                <div className='row d-flex justify-content-start lh-3'>
                                    <div className='container row'>
                                        ...
                                        <div className='col-8 ps-0 font-TTB'>
                                            Description
                                        </div>
                                    ...
                                    <div className='row mt-2 mb-2'>
                                        <div className='container row'>
                                            <div className='col-12 ps-2 pe-2'>
                                                This hidden artwork, created by <span className='font-TTB'>Theme x Silkism</span>, can only by unlocked and revealed by the owner of this Mys<span>t</span>ery Box.
                                            </div>
                                        </div>
                                    </div>
                                </AnimateHeight>
                            ...
                            <div className='border-radius-25 pt-2 pb-2 mb-2' style={{border: '2px solid #7D75FE'}}>
                                ...
                                <div className='row mt-2 mb-2'>
                                    <div className='container row'>
                                        <div className='col-12 ps-2 pe-2'>
                                            Who doesn't love some mys<span>t</span>ery?<br /><b className='font-TTB text-decoration-underline' role={'button'} onClick={() => {passLogin(true)}}>Regis<span>t</span>er</b> and open your mys<span>t</span>ery box--each is revealing the surprise artwork!
                                        </div>
                                    </div>
                                </div>
                                </AnimateHeight>
                    ...
                    <div className='row d-flex justify-content-center'>
                        <div className='row d-flex justify-content-center position-relative mt-3 mb-3 p-2 ps-0 pe-0 col col-sm-11' style={{border: '2px solid #7D75FE', borderRadius: '25px'}} >
                                ...
                                transferData?(
                                    ...
                                    <>
                                        {Object.values(transferData).map((item_trans:any, index:any)=>{
                                            return (<div className='row text-start mt-2 mb-2 fs-8'>
                                                <div className='col-3 p-0 mt-auto mb-auto'>
                                                    <div>
                                                ...
                                                <div className='col-3 pt-0 pb-0 pe-0 ps-1 mt-auto mb-auto'>
                                                    {item_trans.DateTime}
                                                </div>
                                            </div> )
                                        })}
                            ...
                            <div className='row text-start fs-8 '>
                                <div className='col-3 p-0 mt-auto mb-auto'>
                                    <div>
                                        <BsStar /> Minted
                                    </div>
            ...
            <div className='row d-flex justify-content-center'>
                <div className='row border-radius-25 mt-3 mb-3 p-0 col col-sm-11' style={{border: '2px solid #7D75FE'}}>
                    <div className='row d-flex justify-content-start lh-3'>
                        <div className='containter row'>
                            <div className='col col-sm-12 ps-0 font-TTB text-start'>
                                ...
                                More From This Collec<span>t</span>ion
                            </div>
                        </div>
                    ...
                    <hr className='m-0'/>
                    <div className='pt-2 pb-2 d-flex justify-content-center mt-3 mb-3'>
                        <div className='bg-7DFE p-2 text-white border-radius-25 w-50' role='button' onClick={handleClick}>
                            View Collection
                        </div>
                    </div>
                </div>
