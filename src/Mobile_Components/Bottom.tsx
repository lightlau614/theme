        ...
        <div className='mw-100 text-white mt-5 pt-5'>
            <div className='container mb-5'>
                <div className='row d-flex justify-content-center'>
                    <div className='text-start display-5 font-TTB'>
                    ...
                    <div className='text-start mt-4'>
                        ...
                        <div className='row'>
                            <div className='col p-0'>
                                ...
                                <div className='pt-2'>
                                    <SocialIcon url="https://www.instagram.com/rarebbit.theme/" bgColor='#FFF' network='instagram' style={{width: '40px', height: '40px'}} className='' />
                                </div>
                            </div>
                        </div>
                    </div>
