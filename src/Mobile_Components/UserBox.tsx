                                    ...
                                    {!getForget?(
                                        ...
                                        {!forget?(
                                            <>
                                                {change !== 'true'?(
                                                <>
                                                    <div className='col-12 col-sm-5 bg-F91B border-radius-25 lh-3 p-auto m-2' role={'button'} onClick={handleSubmit}>
                                                            Login
                                                    </div>
                                                    <div className='col-12 col-sm-5 bg-7DFE border-radius-25 lh-3 p-auto m-2' role={'button'} onClick={handleForget}>
                                                            Forget Password
                                                    </div>
                                                </>
                                                ):(
                                            ...
                                            <>
                                                <div className='col-12 col-sm-5 bg-F91B border-radius-25 lh-3 p-auto m-2' role={'button'} onClick={handleSubmit}>Reset Password</div>
                                                <div className='col-12 col-sm-5 bg-7DFE border-radius-25 lh-3 p-auto m-2' role={'button'} onClick={()=>{setForget(false); setChange('false')}}>Back to Sign In</div>
                                            </>
                                        )}
                                        </>
                                    ):(
                                        <>
                                            <div className='col-12 col-sm-5 bg-F91B border-radius-25 lh-3 p-auto m-2' role={'button'} onClick={handleSubmit}>Confirm</div>
                                            <div className='col-12 col-sm-5 bg-7DFE border-radius-25 lh-3 p-auto m-2' role={'button'} onClick={()=>{setForget(false); setChange('false')}}>Back to Sign In</div>
                                        </>
                                    )}
                                </div>
