        ...
        <>
            ...
            >
                <form onSubmit={handleSubmit}>
                    <DialogContent>
                        <div className='position-relative w-100 mw-100 h-100 mh-100 p-3'>
                            ...
                            <div className=''>
                                ...
                                <div className='text-center fs-5 position-relative h-100 mt-4'>
                                    ...
                                    <div className='position-relative mt-3'>
                                        <div className='w-50 p-3 bg-7DFE m-auto' style={{borderRadius: 25}}>
                                            <div className='mt-1 mb-4 font-24 text-white'>
                                                TYPE IN TOKEN CODE
                                            </div>
                                            <div className='w-100  mb-4'>
                                                <div className='w-80 m-auto bg-FFF border-radius-25'>
                                        ...
                                        <div className='w-50 d-flex justify-content-start position-relative '>
                                            <div className='w-25 position-absolute' style={{top: '-50px', left: '45%'}}>
                                                <img className='img-fluid' src={require('../Resources/Asset/images/Image_money.png')} />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div className='m-auto mt-3 w-25 text-center bg-F91B border-radius-25 mt-5'>
                                    <div className='m-auto mt-2 mb-2 lh-3 text-white font-TT' role={'button'} onClick={handleSubmit}>Redeem</div>
                                </div>
                            </div>
                        </div>
                    </DialogContent>
