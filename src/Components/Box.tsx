            ...
            {dataframe? dataframe && dataframe.map((item:any, index:any)=>{
                ...
                return (
                    <>
                        ...
                        (
                        <>
                            <div className='col col-sm-12 col-md-3 col-lg-2 m-1 p-1' style={{borderRadius: pathname!== '/me'? '25px': '', border : pathname !== '/me'? '2px solid #7D75FE':''}}>
                        ...
                        <>
                            <div className='row d-flex justify-content-center fs-4 font-TT pt-5 mt-5'>
                                ...
                                <div className='w-25 text-center bg-F91B border-radius-25 mt-5'>
