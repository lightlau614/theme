        ...
        <div className='mw-100 mt-5 pt-5'>
            <div className='container mb-5 mt-5 pt-5 pb-5'>
                <div className='row d-flex justify-content-center'>
                    <div className='col col-lg-5 text-start display-5 font-TTB color-7DFE'>
                        Connect with us
                    </div>
                    <div className='col text-start'>
                        ...
                        <div><SocialIcon url="https://www.instagram.com/rarebbit.theme/" bgColor='#F9A01B' network='instagram' /></div>
                    </div>
                    <div className='col text-start'>
