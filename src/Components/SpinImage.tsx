                ...
                <DialogContent>
                    <DialogContentText>
                        ...
                        <div className='row d-flex justify-content-center position-relative'>
                            ...
                            <div className='w-50 top-50 start-50 position-absolute translate-middle p-3'>
                                    ...
                                    {!haveOrder?(
                                        <>
                                            <div className='row d-flex justify-content-center'>
                                                <div className='col col-sm-4 m-3 text-center bg-F91B border-radius-25'>
                                                    <div className='m-auto mt-2 mb-2 lh-3 text-white font-TT'  role='button' onClick={handleMake}>Customise Hoodie</div>
                                                </div>
                                                <div className='col col-sm-4 m-3 text-center bg-7DFE border-radius-25'>
                                                    <div className='m-auto mt-2 mb-2 lh-3 text-white font-TT'  role='button' onClick={()=>{ window.location.href = '/me'}}>See My Profile</div>
                                                </div>
                                            </div>
                                        </>
                                    ):(
                                        <>
                                            <div className='row d-flex justify-content-center'>
                                                <div className='col-12 col-sm-4 m-1 text-center bg-9390 border-radius-25'>
                                                    <div className='mt-2 mb-2 lh-3 text-white font-TT'  role='button' >Customised Hoodie</div>
                                                </div>
