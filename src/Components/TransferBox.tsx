                    ...
                    <DialogContentText>
                        ...
                        (
                            <>
                                ...
                                <div className='m-auto mt-3 w-50 text-center bg-F91B border-radius-25'>
                                    <div className='m-auto mt-2 mb-2 lh-3 text-white font-TT'  role='button' onClick={handleChange}>Send Through Email</div>
                                </div>
                            </>
                        ):(
                            <>
                                {!success?(
                                    <>
                                        ...
                                        <div className='m-auto mt-3 w-50 text-center bg-F91B border-radius-25'>
                                            <div className='m-auto mt-2 mb-2 lh-3 text-white font-TT'  role='button' onClick={() => {handleSumbit()}} >Send Through Email</div>
                                        </div>
                                    </>
                                ):(
                                    <>
