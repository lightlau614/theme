...
const Rarebbit_box = (list:any) =>{
    ...
    return list.list && list.list.map((item:any)=>{
            ...
            return (
                <div key={item.id} className='col-6 col-sm-6 col-md-6 mt-3 mb-3'>
                    <div className='position-relative mb-3'>
                        <div className=''>
                            <img className='img-fluid' src={item.bg} />
                        </div>
                        <div className='position-absolute top-0 start-0 translate-center p-2'>
                            <img className='img-fluid' src={item.src} />
                        </div>
                    </div>
                    <div className='text-white mb-3 fs-4 font-TTB'>
                        {item.Name}
                    </div>
                    <div className='text-white mb-3 fs-6' dangerouslySetInnerHTML={{ __html: item.Content }} />
                </div>    
            )
            ...
            <div className='main-body' 
                ...
                <div className='container position-relative'>
                    ...
                    <div className='d-flex justify-content-center mt-2 mb-2'>
                        <NavHashLink to='/collection#Intro' className='row d-flex justify-content-center w-50 text-decoration-none'>
